 ...
 */
final class Version20211029091021 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vote_comment (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, comment_id INT NOT NULL, upvote TINYINT(1) NOT NULL, downvote TINYINT(1) NOT NULL, INDEX IDX_1FC60DF4A76ED395 (user_id), INDEX IDX_1FC60DF4F8697D13 (comment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
